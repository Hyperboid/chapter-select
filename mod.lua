function Mod:init()
    ...
    self.debug = true -- If true, Deltarune Chapter 2's Debug Room menu will appear when selecting Chapter 2 - The Debug room will not be the same one as Deltarune's, though.
